...
namespace ePizzaHub.UI.Areas.Admin.Controllers
{
    ...
    public class ItemController : BaseController
    {
        ...
        public ItemController(IItemService itemService, IUtilityService utilityService, IMapper mapper, ICategoryService categoryService)
        {
        ...
        public IActionResult Index(int? categoryId)
        {
            ...
            var mappedItem = _mapper.Map<IEnumerable<ItemVM>>(items);

            if (categoryId != null)
            {
                var itemsByCategory = mappedItem.Where(i => i.CategoryId == categoryId).ToList();
        ...
        public IActionResult Create(int? id)
        {
            ...
            else
            {
                ...
                var mappedItem = _mapper.Map<AddOrEditItemVM>(item);
        ...
        public IActionResult Create(AddOrEditItemVM model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Add
                    var mappedData = _mapper.Map<Item>(model);
